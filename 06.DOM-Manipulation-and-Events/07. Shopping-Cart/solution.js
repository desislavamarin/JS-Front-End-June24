function solve() {
   ...
   const productCatalogue = document.querySelector('.shopping-cart');
   let products = [];
   ...
   checkoutButton.addEventListener('click' , (e) => {
      ...
      const productsList = [...new Set(products.map(product => product.name))];

      resultElement.value += `You bought ${productsList.join(', ')} for ${totalPrice.toFixed(2)}.`;
